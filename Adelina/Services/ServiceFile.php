...
class ServiceFile {
        ...
        if (is_dir($directory)) {
            ...
            if ($dirObject = opendir($directory)) {
                ...
                while (($file = readdir($dirObject)) !== false) {
                    ...
                    // We get the image with the new method.
                    $tmpPicture = self::getOnePicture($directory,$file);
                    
                    // It's a real image? If null, the file doesn't exist or it's not a image.
                    if($tmpPicture != null)
                    {
                        $array[count($array)] = $tmpPicture;
                    }
    ...
    /**
     * Getting one picture object.
     * @param String $directory Directory
     * @param String $file The name of the file.
     */
    public static function getOnePicture($directory,$file) {
        ...
        // Error : we can't get the picture
        return null;
